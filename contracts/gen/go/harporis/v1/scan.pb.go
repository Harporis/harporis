...
func (x *OutputConfig) GetContextLines() int32 {
	if x != nil {
...
const file_harporis_v1_scan_proto_rawDesc = "" +
	...
	"\aformats\x18\x03 \x03(\tR\aformats\x12#\n" +
	"\rcontext_lines\x18\x04 \x01(\x05R\fcontextLines\x1a9\n" +
